...
if __name__ == "__main__":
    ...
    tweetfiles[2011] = {
        9: "https://archive.org/download/archiveteam-twitter-json-2011/twitter-json-scrape-2011-09.zip/",
        10: "https://archive.org/download/archiveteam-twitter-json-2011/twitter-json-scrape-2011-10.zip/",
        11: "https://archive.org/download/archiveteam-twitter-json-2011/twitter-json-scrape-2011-11.zip/",
        12: "https://archive.org/download/archiveteam-twitter-json-2011/twitter-json-scrape-2011-12.zip/",
    }
            ...
            try:
                ...
                if tar_file_names:
                    for file_name in tar_file_names:
                        ...
                        tweetfiles[year][month].append(f"https://archive.org/download/archiveteam-twitter-stream-{year}-{month:02d}/{file_name}/")
    ...
    open("tweettarfiles.json", "w").write(json.dumps(tweetfiles))
