...
const legendMap: Record<string, any> = {
  positive: { title: 'Positive', dataKey: 'positive', color: ColorMap.positive },
  neutral: { title: 'Neutral', dataKey: 'neutral', color: ColorMap.neutral },
  negative: { title: 'Negative', dataKey: 'negative', color: ColorMap.negative },
}
...
export default function SentimentGroupsWeekly() {
  ...
  tweetOjects.forEach((tweet_object) => {
    ...
    date_counts[date_key][tweet_object.sentiment] += 1;
  });
